            ...
            >
              <div className="w-full flex justify-between">
                ...
                <div>
                  <AiOutlineClose
                    onClick={onClose}
                    className="text-3xl rounded-md p-2 flex items-center justify-center hover: hover:bg-rose-500 hover:text-white focus:outline-none focus:ring-2 focus:ring-inset focus:ring-red-500 cursor-pointer "
                  />
                </div>
              </div>
              ...
              <div className="flex justify-end gap-4">
                ...
                <button
                  ...
                  className="hover:bg-red-600 bg-red-500 text-white text-ls hover: border border-red-700 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2 text-center me-2 mb-2 dark:border-white-400 dark:text-white-400 dark:hover: dark:hover:bg-white-500 dark:focus:ring-purple-900"
                >
                  Delete
                </button>
              </div>
